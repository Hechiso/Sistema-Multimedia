...
document.addEventListener('DOMContentLoaded', function() {
  ...
  menu.addEventListener('click', function(){
    ...
    var canciones = [
      { nombre: 'ListaPP', enlace: 'Paginas/pagina1.html' },
      { nombre: 'Anime', enlace: 'Paginas/anime.html' },
      { nombre: 'Peliculas', enlace: 'Paginas/Pelis.html' },
      { nombre: 'Descargas' enlace: 'Paginas/Descargas.html' }	   
    ];
